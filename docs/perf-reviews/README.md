...
| 04 | [Scheduler on external/network storage](04-network-storage-scheduler.md) — render-stall counters; external-SSD baseline (healthy, uncapped-sweep A/B) + the same-size corpus over SMB | 2026-07-24 |
